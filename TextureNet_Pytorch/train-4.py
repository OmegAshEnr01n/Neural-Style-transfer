...
from Generator1 import TransformerNet as genNet
import utils
		...
		for i, data in enumerate(loader):
			...
			while iter < max_iter:
				...
				if i % save_every == 0:
					...
					input_img = utils.tensor_to_img(inp[0].squeeze(0))
					y_img.save(os.path.join(outf,'y',str(i)+'y.png'))
					input_img.save(os.path.join(outf,'x',str(i)+'x.png'))
			...
			torch.save(generator_net.state_dict(),os.path.join(outf,'Trained',str(i)+'Gen_net.pt'))
...
def main():
	...
	parser.add_argument('--print_every', type=int,
						default=10, help='data_directory')
	parser.add_argument('--save_every', type=int,
						default=10, help='data_directory')
	parser.add_argument('--del_lr', type=int,
						default=1000, help='data_directory')
